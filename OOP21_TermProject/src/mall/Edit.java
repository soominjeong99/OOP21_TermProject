	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == eName){
			check = JOptionPane.showConfirmDialog(this, "수정하시겠습니까?\n" + 
					"상품명 : " + tName.getText() ,"메시지", JOptionPane.INFORMATION_MESSAGE );
			if(check ==0){
			...
			check = JOptionPane.showConfirmDialog(this, "수정하시겠습니까?\n" + 
					"회원 나이 : " + tNum.getText() ,"메시지", JOptionPane.INFORMATION_MESSAGE );
			if(check ==0){
			...
			check = JOptionPane.showConfirmDialog(this, "수정하시겠습니까?\n" + 
					"전화번호 : " + tPrice.getText() ,"메시지", JOptionPane.INFORMATION_MESSAGE );
			if(check ==0){
